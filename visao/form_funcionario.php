...
<form action="../banco/conn_func.php" method="POST">
    <h1>Formulário de Inscrição do Funcionário</h1>
    ...
    <div class="campo-input">
        <input type="text" name="user" placeholder="Usuário" style="text-align: center">
    </div>
    <div class="campo-input">
